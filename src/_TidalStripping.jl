...
jacobi_scale(r_host::T, ρs::T, hp::HaloProfile{S}, host::HostModel{T, U}) where {T<:AbstractFloat, S<:Real, U<:Real} = jacobi_scale(r_host, ρs, hp, host.ρ_host_spherical(r_host), host.m_host_spherical(r_host))
